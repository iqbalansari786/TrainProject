...
<div id="navbar">
			...
			<div class="rightmenu">
				<ul >
				 ...
				 <li class="dropdown"> <a href="#">Train </a>
	...
	box-sizing: border-box;padding-left: 20px">
      ...
      <span>
		<input type="submit" value="modify" style=" border-radius: 10%;background-color:#cf34eb;padding: 10px;font-size: 20px;color: #fff" /></span>
